...
Robert van den Breemen did the research on the differences between the
Dutch- and Belgium Smart Meters.

All I did was clone the repository of Matthijs and added the specific Belgium
OBIS fields found by Robert.

I renamed the repository and all the files with "-BE" at the end 
(dsmr -> dsmr-BE, parser.h -> parser-BE.h, reader.h -> reader-BE.h) so this patched
version (<b>dsmr-BE</b>) can coexist with the original <b>dsmr</b> library.

This should all have been done by a professional as I have no clue of C++11 or templates!

Anyway: all the software-engeneering is done by Matthijs who
